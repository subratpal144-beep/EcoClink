      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A student-led initiative giving waste new purpose — from keychains and bags to creative
            accessories
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <Card className="p-8 space-y-4">
            ...
            <h3 className="text-2xl font-semibold" data-testid="text-who-we-are">
              Who We Are
            </h3>
            <p className="text-muted-foreground leading-relaxed">
              Our mission is to transform leftover fabrics into useful, eco-friendly creations —
              from keychains and bags to many more sustainable products. Each design helps cut down
              textile waste and shows that creativity and environmental care can go hand in hand.
            </p>
          </Card>
          ...
          <Card className="p-8 space-y-4">
            ...
            <h3 className="text-2xl font-semibold" data-testid="text-our-mission">
              Our Mission
            </h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            <div className="text-center space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Each creation is made by hand, combining eco-conscious thinking with a touch of
                artistry.
              </p>
            </div>
